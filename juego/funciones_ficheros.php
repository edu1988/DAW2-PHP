<?php
    ...
    /*Función para volcar el contenido de un fichero en un array unidimensional.
    Cada fila será un elemento del array */
    function fileToArrayUni($nombreFich,&$lista){
        $lista=file($nombreFich,FILE_IGNORE_NEW_LINES);
    }

    function arrayToFileUni($lista,$nombreFich){
        //Abrimos el fichero o lo creamos si no existe (para escritura)
        $fichero=fopen($nombreFich,"w");
