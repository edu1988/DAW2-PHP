    ...
    <?php
        ...
        if(isset($_POST["enviar"])){
            ...
            if($_POST["dni"]=="admin" && $_POST["pass"]=="1234"){
                ...
                echo "<META HTTP-EQUIV='REFRESH' CONTENT='1;URL=http://localhost/login2/backend.php?admin=admin&pass=1234'>";
            }else{
                ...
                if(is_int($resultado)){
                    ...
                    if($passIntroducido==$passReal){
                        ...
                        echo "<META HTTP-EQUIV='REFRESH' CONTENT='1;URL=http://localhost/login2/frontend.php'>";
