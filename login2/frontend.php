...
<body>
    <?php
        ...
        if(file_exists("sesion.txt")){
            ...
            echo "<table>
                    <tr>
                    <td><h1>BIENVENIDO/A " .$nombre. "</h1></td>
                    </tr>
                    <tr>
                    <td>El saldo de tu cuenta es: " . $saldo . " euros.</td>
                    </tr>
                    <tr>
                    <td>El saldo medio de tu localidad es: ".$saldoMedio." euros.</td>
                    </tr>
                </table>";
        }else{
