<?php
    ...
    /*Eliminar una fila en un array no ordenado (busqueda secuencial) */
    function eliminarFila(&$tabla,$columna,$valor){
        //Buscamos el valor pasado en la columna correspondiente
        $indiceFila=busquedaSecuencial($tabla,$columna,$valor);
        if($indiceFila==-1){
    ...
    /*Eliminar una fila en un array ordenado (busqueda binaria) */
    function eliminarFila2(&$tabla,$columna,$valor){
        //Buscamos el valor pasado en la columna correspondiente
